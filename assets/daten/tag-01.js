...
},
{
  ...
  tabelle: {
    kopf: ["Ausdruck", "Bedeutung", "So benutzt du ihn"],
    zeilen: [
      ["auf Kärtchen notieren", "note on flashcards", "Ich notiere <b>Stichpunkte auf Kärtchen</b>."],
      ["hören und nachsprechen", "listen and repeat", "Wörter <b>hören und nachsprechen</b> übt die Aussprache."],
      ["gemeinsam etwas tun", "do something together", "Wir machen die Aufgaben <b>gemeinsam</b>."],
      ["den Stoff durchdenken", "think the material through", "Ich <b>denke den Stoff</b> abends noch einmal <b>durch</b>."],
      ["in der Lerngruppe kommunizieren", "communicate in the study group", "Wir diskutieren <b>den Stoff in der Lerngruppe</b>."],
      ["sich bewegen", "move around", "Sich <b>beim Lernen</b> zu bewegen hilft."],
      ["mit eigenen Worten zusammenfassen", "summarise in your own words", "Ich fasse den Stoff <b>mit eigenen Worten</b> zusammen."],
      ["nach Farben ordnen", "organise by colour", "Ich ordne den Stoff gern <b>nach Farben</b>."],
      ["im Raum herumlaufen", "walk around the room", "Man kann <b>im Raum</b> herumlaufen."],
      ["praktisch anwenden", "apply in practice", "Es ist gut, <b>etwas praktisch</b> anzuwenden."]
    ]
  },
...
},
{
  ...
  tabelle: {
    kopf: ["Zustimmen und begründen", "Widerspruch ausdrücken und begründen"],
    zeilen: [
      ["Ich finde auch, <b>dass</b> …", "Ich meine nicht, <b>dass</b> man sagen kann „…“."],
      ["Ich bin der gleichen Meinung, <b>denn</b> …", "Da bin ich ganz anderer Ansicht, <b>weil</b> …"],
      ["Ja, das stimmt, diese Erfahrung habe ich auch gemacht, <b>als</b> ich …", "Im Prinzip stimmt das, <b>aber</b> …"],
...
},
{
  ...
  tabelle: {
    ...
    zeilen: [
      ["Ich finde das <b>gut</b>.", "gut", "die Bewertung ist die Information"],
      ["Da stimme ich <b>zu</b>.", "zu", "das Präfix trägt die Bedeutung von „zustimmen“"],
      ["Ich bin der <b>gleichen</b> Meinung.", "gleichen", "„gleich“ ist der Kern der Zustimmung"],
...
items: [
  { typ:"luecke", thema:"wortschatz", frage:"Satz 1:", satz:"Man kann ___ ___ herumlaufen.", loesung:["im","Raum"],
  ...
  { typ:"luecke", thema:"wortschatz", frage:"Satz 9:", satz:"Zur Kontrolle kann man sich mit dem ___ aufnehmen.", loesung:[["Handy","handy"]],
    regel:"sich auf|nehmen = record oneself. Reflexiv + trennbar.", en:"record yourself with your phone" },
  { typ:"luecke", thema:"wortschatz", frage:"Satz 10:", satz:"Sich ___ ___ zu bewegen hilft.", loesung:["beim","Lernen"],
    regel:"„beim Lernen“ = bei + dem + substantiviertes Verb. Nomenisierte Verben sind immer neutrum und werden großgeschrieben.",
    en:"beim Lernen = while studying (nominalised verb, always neuter)" }
]},
...
items: [
  { typ:"zuordnen", thema:"redemittel",
    frage:"Ordne die Redemittel ihrer Funktion zu.",
    paare:[
      ["Ich finde auch, dass …","zustimmen"],
      ["Da bin ich ganz anderer Ansicht, weil …","widersprechen"],
  ...
  { typ:"mc", thema:"redemittel", frage:"„Ich meine nicht, dass man sagen kann „…“.“",
    optionen:["zustimmen","widersprechen"], richtig:1,
  ...
  { typ:"luecke", thema:"nebensatz", frage:"Wortstellung nach „denn“ — Achtung, anders!",
    ...
    en:"denn keeps normal word order; weil does not." },
  { typ:"ordnen", thema:"redemittel",
    frage:"Bau das Original aus dem Kursbuch (Antwort auf „Eine Sprache lernen ist wirklich Arbeit!“).",
    woerter:["Im","Prinzip","stimmt","das,","aber","das","ist","eine","Arbeit,","die","Spaß","macht."],
    loesung:"Im Prinzip stimmt das, aber das ist eine Arbeit, die Spaß macht.",
    regel:"„Im Prinzip“ auf Position 1 → Verb „stimmt“ auf Position 2. Am Ende ein Relativsatz: „die Spaß macht“ (Verb am Ende)." , en:"<b>Im Prinzip</b> fills position one, so <b>stimmt</b> comes second; the relative clause ends with <b>macht</b>." },
  { typ:"ordnen", thema:"redemittel",
    frage:"Bau die zweite Original-Antwort.",
    woerter:["Ich","finde","auch,","dass","Sprachen","lernen","viel","Arbeit","ist."],
    loesung:"Ich finde auch, dass Sprachen lernen viel Arbeit ist.",
    regel:"Nach „dass“ das Verb „ist“ ganz ans Ende." , en:"After <b>dass</b> the conjugated verb moves to the very end, so <b>ist</b> closes the clause." }
]},
...
items: [
  ...
  { typ:"frei", thema:"sprechen",
    ...
    muster:"<b>Im Prinzip stimmt das, aber</b> ich glaube, viele Lerner haben Angst vor der Aufnahme. " +
      "<b>Ich finde auch, dass</b> gegenseitige Korrektur sehr effektiv ist, <b>denn</b> man hört seine eigenen Fehler sonst nie. " +
  ...
  { typ:"frei", thema:"infinitiv-zu",
    ...
    mindestWorte:12,
    hinweise:["Es hilft, … zu …","Es ist gut, … zu …","Es lohnt sich, … zu …"],
    muster:"<b>Es hilft</b>, jeden Tag zehn Minuten laut <b>zu sprechen</b>, auch wenn man alleine ist. " +
      "<b>Es hilft</b> außerdem, neue Wörter sofort in einem eigenen Satz <b>anzuwenden</b>.",
    kriterien:"„Es hilft, …“ verlangt Infinitiv mit „zu“ am Ende. Bei trennbaren Verben: anzuwenden, aufzuschreiben, mitzumachen." , en:"<b>Es hilft</b> needs an infinitive with <b>zu</b> at the end; separable verbs split around it: anzuwenden." }
]},
...
items: [
  ...
  { typ:"luecke", thema:"artikelwoerter", b1:true, frage:"Possessivartikel im Dativ:",
    satz:"Ich habe mit ___ Lehrerin gesprochen. (mein)", loesung:[["meiner"]],
    regel:"„mit“ + Dativ, feminin → mein<b>er</b> Lehrerin. Das war heute dein Fehler im Chat!",
    gegenbeispiel:"Du hattest geschrieben: „ich hat gefragt mein lehrerin“ → „ich habe meine Lehrerin gefragt“ (Akkusativ) bzw. „mit meiner Lehrerin“ (Dativ)." , en:"<b>mit</b> always takes Dativ, and the feminine Dativ ending is -er: <b>meiner</b> Lehrerin." },
...
wortschatz: [
  { de:"der Vorschlag, ¨-e", en:"suggestion, proposal", bsp:"Das ist ein guter Vorschlag, weil er einfach ist." },
  { de:"die Ansicht, -en", en:"view, opinion", bsp:"Da bin ich ganz anderer Ansicht." },
  { de:"Stellung nehmen (zu + Dativ)", en:"to take a position on", bsp:"Nehmen Sie zu den Aussagen Stellung." },
  { de:"zustimmen (+ Dativ)", en:"to agree", bsp:"Da stimme ich dir zu." },
  { de:"widersprechen (+ Dativ)", en:"to contradict, disagree", bsp:"Ich möchte dir hier widersprechen." },
  { de:"der Stichpunkt, -e", en:"key point, bullet point", bsp:"Ich notiere Stichpunkte auf Kärtchen." },
  { de:"das Kärtchen, –", en:"small card, flashcard", bsp:"Ich schreibe neue Wörter auf Kärtchen." },
  { de:"zusammenfassen (fasst zusammen)", en:"to summarise", bsp:"Ich fasse den Stoff mit eigenen Worten zusammen." },
  { de:"anwenden (wendet an)", en:"to apply, use", bsp:"Es ist gut, etwas praktisch anzuwenden." },
  { de:"nachsprechen (spricht nach)", en:"to repeat after someone", bsp:"Wörter hören und nachsprechen übt die Aussprache." },
  { de:"durchdenken (denkt durch)", en:"to think through", bsp:"Ich denke den Stoff abends noch einmal durch." },
  { de:"der Satzakzent, -e", en:"sentence stress", bsp:"Dieses Wort trägt den Satzakzent." },
  { de:"im Prinzip", en:"in principle, basically", bsp:"Im Prinzip stimmt das, aber …" },
  { de:"die Erfahrung, -en (eine Erfahrung machen)", en:"experience (to have an experience)", bsp:"Diese Erfahrung habe ich auch gemacht." },
  { de:"gegenseitig", en:"mutual(ly), each other", bsp:"Man sollte sich gegenseitig korrigieren." }
],
